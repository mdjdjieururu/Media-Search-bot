...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if len(btn) > 10: 
            ...
            if poster:
                await message.reply_photo(photo=poster, caption=f"<b>🍿 ᴍᴏᴠɪᴇ ɴᴀᴍᴇ : {search} ‌‌‌‌‎ ­  ­  ­  ­  ­ </b> <b>🔔 ᴄʜᴀɴɴᴇʟ : <a href='https://t.me/joinchat/x6V1RmEmmGBhMjQ1MF'>🎬 NEW RELEASE</a>\n⚡️ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : <a href='https://t.me/Oru_autofilter_bot'>ആറാം തമ്പുരാൻ²·⁰</a>\n\n👮‍♂️ ɴᴏᴛɪᴄᴇ : If you don't see the files of the movie you asked for look at next page</b>", reply_markup=InlineKeyboardMarkup(buttons))
        else:
            await message.reply_text(=f"<b>🍿 ᴍᴏᴠɪᴇ ɴᴀᴍᴇ : {search} ‌‌‌‌‎ ­  ­  ­  ­  ­ </b> <b>🔔 ᴄʜᴀɴɴᴇʟ : <a href='https://t.me/joinchat/x6V1RmEmmGBhMjQ1MF'>🎬 NEW RELEASE</a>\n⚡️ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : <a href='https://t.me/Oru_autofilter_bot'>ആറാം തമ്പുരാൻ²·⁰</a>\n\n👮‍♂️ ɴᴏᴛɪᴄᴇ : If you don't see the files of the movie you asked for look at next page</b>", reply_markup=InlineKeyboardMarkup(buttons))
            return
